//==-- bds/utility.h - miscellaneous utility classes/functions --*- C++ -*-==//
//
 ...
 *     used in the implementation of other BDS classes.
 *
...
#ifndef BDS_UTILITY_H
#define BDS_UTILITY_H
